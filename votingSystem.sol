...
//     // Decrease the voter's weight by 1
//     require(sender.weight > 0, "Weight cannot be decreased further");
//     sender.weight--;
...
// }
    ...
    // Decrease voter's weight by 1
    sender.weight--;

    // Reset voted status to false if weight is still greater than 0
    if (sender.weight > 0) {
        sender.voted = false;
        }
